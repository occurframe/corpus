...
Canonical vectors are individual UTF-8 JSON files at `vectors/<family>/<VECTOR-ID>.json`, validated by `schemas/vector.schema.json`. `corpus_version` is `1.0.0-rc2`; `schema_version` is `1.0.0`.
